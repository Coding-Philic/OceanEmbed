#!/usr/bin/env python3
"""
Download: Wind U & V — CMEMS CERSAT Blended L4
===============================================
Run this script directly:
    python3 scripts/download/dl_wind.py

What gets downloaded:
    • eastward_wind   — Wind U component (m/s)
    • northward_wind  — Wind V component (m/s)
    • Output → data/raw/wind/
...
print("="*60)
print("🌊  OceanEmbed v2 — Wind U/V Download")
